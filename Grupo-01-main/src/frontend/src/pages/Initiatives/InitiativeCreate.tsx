...
export default function InitiativeEdition() {
  const [initiative, setInitiative] = useState<IInitiative>({company: {id: 0, name: ''}, name: '', status: '', createdAt: '', updatedAt: '', description: '', observation: '', id: 0, module: {id: 0, name: '', course: {id: 0, name: ''}}});
